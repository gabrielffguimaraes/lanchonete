                        ...
                        <div class="col-sm-6">
                            <div class="product-images">
                                <div class="product-main-img">
                                    <img src="<?=$baseUrl?>assets/img/product-2.jpg" alt="">
                                </div>

                                <div class="product-gallery">
                                    <img src="<?=$baseUrl?>assets/img/product-thumb-1.jpg" alt="">
                                    <img src="<?=$baseUrl?>assets/img/product-thumb-2.jpg" alt="">
                                    <img src="<?=$baseUrl?>assets/img/product-thumb-3.jpg" alt="">
                                </div>
                            </div>
                        </div>
